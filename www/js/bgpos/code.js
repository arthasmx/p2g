...
$(function() {
  ...
  var current = 0;
  var images=["hotel","food","having-fun","places-to-visit"];
  ...
  for(var iteration = 0; iteration <4; ++iteration)
       ...
       $(this).find('li').fadeIn();
   ...
   }).attr('src', baseUrl + 'media/images/pc/' + images[iteration] + '.jpg');
              ...
              function move(dir,item){
                  if(dir){
                      ...
                      $('#bg4').parent().stop().animate({backgroundPosition:"(-798px 0)"},400,function(){
