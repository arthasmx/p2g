jQuery(document).ready(function(){
  ...
  var mp_filelist = '#banner-filelist';
  var mp_up_btn   = '#banner-upload';
  var mp_uploader = new plupload.Uploader( get_shared_options( baseUrl + '/banner/upload','banner_pix','banner-pick','jpg') );
