...
class Articles_FoodController extends Module_Articles_Controller_Action_Frontend{
  ...
  function readAction(){
    ...
    App::module('Core')->getModel('Libraries')->jquery_vegas_default('food');
  ...
  function listAction(){
    ...
    $this->view->food            = $this->_module->getModel('Business')->get_business_list( $this->getRequest()->getParam( App::xlat('route_paginator_page') ), $this->getRequest()->getParam('type'), 'enabled' );
