...
class Module_Email_Repository_Model_Default_Contact extends Module_Email_Repository_Model_Email {
  ...
  // Accede al sender del email (Zend_Mail), lo configura, carga el contenido de las plantillas y envía el email.
    ...
    // Generamos el contenido del email (todos los atributos en $this se asignan a la vista del bloque de la plantilla)
      $this->body=array(
        "html"  =>  $this->_module->renderBlock('default/contact'  , 'html'  , $this->asArray() ),
        "txt"   =>  $this->_module->renderBlock('default/contact'  , 'txt'   , $this->asArray() ),
      );
