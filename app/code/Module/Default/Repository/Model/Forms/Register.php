<?php
class Module_Default_Repository_Model_Forms_Register extends Core_Model_Repository_Model {
  ...
  public function get($post=false) {
    ...
    $form->setDecorators( array( array('ViewScript', array('viewScript' => 'register.phtml'))));    
